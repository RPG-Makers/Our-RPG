...
public abstract class EnemyBase : MonoBehaviour
{
    ...
    protected float _attackingDistance; // ¬озможно следует перенести отдельно в меч и лук. ¬ общем подумать от чего зависит дальность, от врага или оружи€ (от оружи€ наверное???).
